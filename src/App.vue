...
const userLogin = () => {
  if (!showRegistrationForm.value) {
    console.log('Trying to log in with', username.value, password.value);
    ...
    if (matchedUser) {
      ...
      router.push('/');
      // Implement navigation to the dashboard or display success message for login
    } else {
      console.log('Failed to log in');
      // Implement error handling for login
    }
  }
};
